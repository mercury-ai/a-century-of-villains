    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        <div className="p-2 bg-amber-500/10 border border-amber-500/20 rounded-lg">
          <span className="text-[11px] uppercase font-bold tracking-wider text-amber-500 block mb-0.5">
            Peaked In
          </span>
        ...
        <div className="p-2 bg-red-500/10 border border-red-500/20 rounded-lg">
          <span className="text-[11px] uppercase font-bold tracking-wider text-red-500 block mb-0.5">
            Dropped In
          </span>
          <div className="font-bebas text-2xl text-white leading-none">
          ...
          {RAW.map((d, index) => {
            ...
            return (
              <div
                ...
                className={`p-1 px-2 rounded-lg border text-[13px] flex justify-between items-center transition-all cursor-pointer ${
                  isSelectedDecade
              ...
              >
                <span className="font-semibold flex items-center gap-1">
                  {d.decade}
                  {isPeak && <span className="text-[10px] text-amber-500 font-bold uppercase select-none">Peak</span>}
                  {isLow && <span className="text-[10px] text-red-400 font-bold uppercase select-none">Low</span>}
                </span>
